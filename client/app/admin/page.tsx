  ...
  return (
    <>
      ...
      <form className="space-y-6">
        <input placeholder="New Username" className="w-full border px-3 py-2 rounded-md" />
        <input placeholder="Email" className="w-full border px-3 py-2 rounded-md" />
...
function UpdateUserForm() {
  return (
    <>
      ...
      <form className="space-y-6">
        <input placeholder="User ID" className="w-full border px-3 py-2 rounded-md" />
        <input placeholder="New Email" className="w-full border px-3 py-2 rounded-md" />
